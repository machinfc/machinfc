...
**C++ Software Engineer · High-Performance & Scientific Computing**

Ph.D. in Engineering & Applied Physics — I build performance-critical software for simulation and data-intensive workloads.
...
```
Languages     C++17/20 · C · CUDA · Python · Bash · MATLAB
Performance   CMake · OpenMP · cache-aware data structures · Nsight Systems/Compute
              GDB · Valgrind · ASan/UBSan · Linux
Engineering   Git (PR workflow) · GoogleTest · GitHub Actions (CI/CD) · Docker · pybind11
Scientific    NumPy/SciPy/Pandas · HDF5 · VTK · Monte Carlo · FEM/DEM · LiDAR
Cloud         AWS (EC2, S3, ParallelCluster — in progress)
```
...
**Open to C++ / Scientific Software / HPC Engineer roles — remote or relocation.**
[frankcm.work@gmail.com](mailto:frankcm.work@gmail.com)
